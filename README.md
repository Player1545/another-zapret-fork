...
<b>Рекомендую использовать файлы general(ALT11) или general(ALT18), на остольных файлах general(ALT...) могут не работать некоторые сайты(или звонки в телеграме/дискорде)</b><br>
<b>Учтите, что я не собираюсь активно обновлять данный репозиторий. Возможно обновлений вообще не будет в дальнейшем.</b>
...
> В репозитории представлены множество различных стратегий для обхода, в том числе general (ALT11)-general (ALT18), которые содержат различные пути дурения DPI. Если ни одна из них вам не помогает, то вам необходимо создать новую, взяв за основу одну из представленных здесь и изменив её параметры.
...
- `service.bat` -> `2. Remove Services`
- `service.bat` -> `4. Run Diagnostics` (если есть ошибки - устраните их) -> в конце Y
